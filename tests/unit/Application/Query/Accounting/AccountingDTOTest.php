...
/**
 * @covers xVer\MiCartera\Application\Query\Accounting\AccountingDTO
...
{  
    ...
    public function testAccountingDTO(): void
    {
        ...
        $this->assertInstanceOf(MoneyVO::class, $accountingDTO->getMovementAdquisitionExpense(0));
        $this->assertInstanceOf(MoneyVO::class, $accountingDTO->getMovementAdquisitionPrice(0));
    ...
    public function testSetCollectionKeyWithInvalidOffsetThrowsException(): void
    {
        ...
        $accountingDTO->getMovementAdquisitionPrice(1);
    }
}
